...
Shader::Shader(const char* vertexPath, const char* fragmentPath)
{
    ...
    if (success)
    {
        std::cout << vertexPath << " compiled successfully\n";
    }
    else
    {
        glGetShaderInfoLog(vertex, 512, NULL, infoLog);
        std::cout << "ERROR::SHADER::" << vertexPath << "::COMPILATION_FAILED\n" << infoLog << std::endl;
    }
    // fragment Shader
    ...
    if (success)
    {
        std::cout << fragmentPath << " compiled successfully\n";
    }
    else
    {
        glGetShaderInfoLog(fragment, 512, NULL, infoLog);
        std::cout << "ERROR::SHADER::" << fragmentPath << "::COMPILATION_FAILED\n" << infoLog << std::endl;
    }
